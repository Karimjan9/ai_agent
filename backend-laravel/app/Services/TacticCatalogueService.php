...
class TacticCatalogueService
{
    ...
    private const CATALOGUE = [
        ...
        'fibonacci_structure_pullback' => [
            'tactic_id' => 'fibonacci_structure_pullback',
            'label' => 'Fibonacci structure pullback',
            'hypothesis' => 'Trade a causally confirmed swing-leg Fibonacci zone only after a liquidity sweep and rejection.',
            'target_regimes' => ['trend_up', 'trend_down'],
            'entry_topology' => 'confirmed_swing_dynamic_fibonacci_liquidity_rejection',
            'allowed_genes' => ['swing_lookback', 'atr_period', 'equal_level_atr_fraction'],
        ],
        'bos_retest_continuation' => [
            'tactic_id' => 'bos_retest_continuation',
            'label' => 'BOS retest continuation',
            'hypothesis' => 'Require a close-confirmed structure break, displacement and ATR-bounded retest.',
            'target_regimes' => ['trend_up', 'trend_down'],
            'entry_topology' => 'causal_bos_displacement_retest',
            'allowed_genes' => ['swing_lookback', 'atr_period', 'minimum_displacement_atr', 'retest_atr_fraction'],
        ],
        'choch_reversal' => [
            'tactic_id' => 'choch_reversal',
            'label' => 'CHOCH reversal',
            'hypothesis' => 'Use a confirmed character change only with a prior liquidity sweep and reduced-risk contract.',
            'target_regimes' => ['transition'],
            'entry_topology' => 'liquidity_sweep_confirmed_choch',
            'allowed_genes' => ['swing_lookback', 'atr_period', 'transition_confidence_min'],
        ],
        'liquidity_sweep_reversion' => [
            'tactic_id' => 'liquidity_sweep_reversion',
            'label' => 'Liquidity-sweep reversion',
            'hypothesis' => 'Use equal-level and session-range proxies; never claim unseen order-book liquidity.',
            'target_regimes' => ['range'],
            'entry_topology' => 'support_resistance_proxy_sweep_rejection',
            'allowed_genes' => ['swing_lookback', 'atr_period', 'equal_level_atr_fraction', 'zone_strength_min'],
        ],
        'regime_router' => [
