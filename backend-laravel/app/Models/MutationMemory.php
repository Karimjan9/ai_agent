...
{
    protected $fillable = ['lab_agent_id', 'symbol', 'timeframe', 'strategy_family', 'parameter_key', 'old_value', 'new_value', 'forward_delta', 'market_regime', 'outcome', 'confidence', 'decision', 'gate_transition', 'behavioral_effect'];
